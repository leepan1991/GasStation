...
public class GasFillingLog extends AbstractEntity {
    ...
    private String fillingCustomer;
    private String inspector;
    private String fillingCustomerName;

    private String startFillingTime;
    private String endFillingTime;
    ...
    public String getFillingCustomer() {
        return fillingCustomer;
    }

    public void setFillingCustomer(String fillingCustomer) {
        this.fillingCustomer = fillingCustomer;
    }
    ...
    public String getFillingCustomerName() {
        return fillingCustomerName;
    }

    public void setFillingCustomerName(String fillingCustomerName) {
        this.fillingCustomerName = fillingCustomerName;
    }

    public String getStartFillingTime() {
        return startFillingTime;
    }

    public void setStartFillingTime(String startFillingTime) {
        this.startFillingTime = startFillingTime;
    }

    public String getEndFillingTime() {
        return endFillingTime;
    }

    public void setEndFillingTime(String endFillingTime) {
